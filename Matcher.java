...
public class Matcher {
	...
	private static void writeRuntimeEntries(int textSize, Vector<Vector<String>> patterns, float[] naiveRuntimes, float[] kmpRuntimes, BufferedWriter output) throws IOException {
